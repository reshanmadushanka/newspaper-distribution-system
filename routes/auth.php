...
Route::middleware('auth')->group(function (): void {
    ...
    Route::prefix('admin')->name('admin.')->group(function (): void {
        ...
        Route::get('reports/daily-sales', [InvoiceController::class, 'dailySales'])->name('reports.daily-sales')->middleware('permission:manage invoices');
        Route::get('reports/daily-sales/pdf', [InvoiceController::class, 'dailySalesPdf'])->name('reports.daily-sales.pdf')->middleware('permission:manage invoices');
    });
});
