                ...
                <div class="rounded-2xl border bg-card p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" placeholder="John's Grocery" :error="form.errors.name" required />
                        ...
                        <div class="sm:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <Input id="owner_name" v-model="form.owner_name" class="pl-9" placeholder="John Doe" :error="form.errors.owner_name" />
                            </div>
                        </div>
                        <div class="sm:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <Textarea id="address" v-model="form.address" class="pl-9 min-h-[100px]" placeholder="123 Main St, City" :error="form.errors.address" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2 space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <Input id="email" type="email" v-model="form.email" class="pl-9" placeholder="shop@example.com" :error="form.errors.email" />
                            </div>
                        </div>
                    </div>
                </div>
